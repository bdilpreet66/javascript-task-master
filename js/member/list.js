...
function displayUsers(users) {
    ...
    users.forEach(user => {
        ...
        row.innerHTML = `   
            ...
            <td data-label="Hourly Rate">$ ${user.hourlyRate}</td>
            <td data-label="Type">${(user.type == "admin") ? `<span class="badge badge-success">Admin</span>` : `<span class="badge badge-dark">Regular</span>`}</td>
